...
<div class="layout-px-spacing">
         ...
         <!-- END GLOBAL MANDATORY STYLES -->
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Active Summary</li>
                            </ol>
                        </nav>
                    </div></br>
                    <!-- /BREADCRUMB -->
                    <form class="row-6"  method="post"  action="{{ route('activesummary.filter') }}">
                    @csrf   
                    ...
                    <div class="col-sm-2">
                    <input type="date" class="form-control" placeholder="Start Date" name="startDate" aria-label="Start Date">
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm">
                            ...
                            <a href="/plan/summary" class="btn btn-primary btn-lg">View Overall Summary</a>
                        </div>
                   </div>
    ...
    <div class="row" id="cancel-row">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing">
            <div class="widget-content widget-content-area br-8">
                <table id="style-3-1" class="table style-3 dt-table-hover" style="width:100%">
                    <thead>
                        <tr>
                            <th>Date</th>
                            <th>Route</th>
